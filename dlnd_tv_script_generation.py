...
class RNN(nn.Module):
    ...
    def __init__(self, vocab_size, output_size, embedding_dim, hidden_dim, n_layers, dropout=0.2):
        ...
        # embedding layer: is responsible for looking at the input integers and basically creating a lookup table
    ...
    def forward(self, nn_input, hidden):
        ...
        # flatten the lst layer(s) outputs for passing i to the
    ...
    def init_hidden(self, batch_size):
        # initialized the memory of an LSTM layer , an LSTM has a hidden and a cell state
        # that are saved as a tuple
